...
const Header = () => {
    ...
    return (
        <nav className="sticky top-0 z-50 bg-[#F8F9FA] dark:bg-[#080e21] flex justify-between items-center px-20 py-1 h-[80px] shadow-sm">
            ...
            <div className="space-x-6 text-lg">
                ...
                <button className="text-[#475467] pb-2 dark:text-[#ffffff]">Projects</button>
                <button className="text-[#475467] pb-2 dark:text-[#ffffff]">Contact</button>
            </div>
            <div className="space-x-6 text-lg">
                <a href="#_" className="relative inline-flex items-center px-12 py-2 overflow-hidden text-lg font-medium text-[#ffffff] hover:border-2 bg-[#6970E4] hover:border-[#6970E4] rounded hover:text-[#6970E4] group hover:bg-[#fffff]">
                    <span className="absolute left-0 block w-full h-0 transition-all bg-[#ffffff] dark:bg-[#080e21] opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
